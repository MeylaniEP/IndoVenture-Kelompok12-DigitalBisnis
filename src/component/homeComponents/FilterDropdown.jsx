...
function FilterDropdown() {
  ...
  return (
    <div
      className="mt-4 d-flex flex-row justify-content-center align-items-center py-2 px-3"
      style={{
    ...
    >
      ...
      <Form.Group
        ...
        style={{ borderRight: "grey solid 1px" }}
      >
      ...
      {/* Guest Dropdown */}
      <Form.Group controlId="guestSelect">
      ...
      <div
        className="d-flex flex-row fs-3 p-2"
        style={{
          borderRadius: "100px",
